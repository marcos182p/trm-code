...
public class GLCFactory {
    ...
    public static final Terminal OPEN_SQUARE_BRACKET = new Terminal(
            TokenClass.TK_OPEN_SQUARE_BRACKET);
    public static final Terminal CLOSE_SQUARE_BRACKET = new Terminal(
            TokenClass.TK_CLOSE_SQUARE_BRACKET);
    public static final Terminal OPEN_CURLY_BRACKET = new Terminal(
            TokenClass.TK_OPEN_CURLY_BRACKET);
    public static final Terminal CLOSE_CURLY_BRACKET = new Terminal(
            TokenClass.TK_OPEN_CURLY_BRACKET);
    public static final Terminal OPEN_PARENTHESES = new Terminal(
            TokenClass.TK_OPEN_PARENTHESES);
    public static final Terminal CLOSE_PARENTHESES = new Terminal(
            TokenClass.TK_CLOSE_PARENTHESES);
    ...
    public static final Terminal SEMICOLON = new Terminal(
            TokenClass.TK_SEMICOLON);
    public static final Terminal ID = new Terminal(TokenClass.TK_ID);
    public static final Terminal INT_CTE = new Terminal(
            TokenClass.TK_INTEGER_CTE);
    ...
    public static final Terminal CHARACTER = new Terminal(
            TokenClass.TK_CHARACTER);
    ...
    public static final Terminal INTEGER_CTE = new Terminal(
            TokenClass.TK_INTEGER_CTE);
    public static final Terminal REAL_CTE = new Terminal(TokenClass.TK_REAL_CTE);
    public static final Terminal BOOLEAN_CTE = new Terminal(
            TokenClass.TK_BOOLEAN_CTE);
    public static final Terminal CHARACTER_CTE = new Terminal(
            TokenClass.TK_CHARACTER_CTE);
    public static final Terminal STRING_CTE = new Terminal(
            TokenClass.TK_STRING_CTE);
    public static final Terminal ATTRIBUTION = new Terminal(
            TokenClass.TK_ATTRIBUTION);
...
//  Terminal OP_NEG = new Terminal(TokenClass.TK_NEGATIVE);
    ...
    public static final Terminal OP_NOT_EQUAL = new Terminal(
            TokenClass.TK_NOT_EQUAL);
    public static final Terminal OP_MINOR = new Terminal(TokenClass.TK_LESS_THAN);
    public static final Terminal OP_MINOR_OR_EQUAL = new Terminal(
            TokenClass.TK_LESS_OR_EQUAL);
    public static final Terminal OP_MAJOR = new Terminal(TokenClass.TK_GREATER_THAN);
    public static final Terminal OP_MAJOR_OR_EQUAL = new Terminal(
            TokenClass.TK_GREATER_OR_EQUAL);
    //operadoers logicos--------------------------------------------------------
    ...
    public static final Variable OPTIONAL_DECLAR_RETURN =
            new Variable("optional_declaration_return");
    ...
    public static final Variable OPTIONAL_MENOR_PREC_LOG =
            new Variable("[menor_prec_log]");
    public static final Variable MAIOR_PREC_OP_LOG =
            new Variable("maior_prec_op_log");
    public static final Variable OPTIONAL_MAIOR_PREC_OP_LOG =
            new Variable("[maior_prec_op_log]");
    public static final Variable MAIOR_PREC_UN_LOG =
            new Variable("maior_prec_un_log");
    ...
    public static final Variable MENOR_PREC_ARIT_OPERATORS =
            new Variable("menor_prec_arit_op");
    public static final Variable OPTIONAL_MENOR_PREC_ARIT =
            new Variable("[menor_prec_arit]");
    public static final Variable MAIOR_PREC_OP_ARIT =
            new Variable("maior_prec_op_arit");
    public static final Variable MAIOR_PREC_OP_ARIT_OPERATORS =
            new Variable("maior_prec_op_arit_op");
    public static final Variable OPTIONAL_MAIOR_PREC_OP_ARIT =
            new Variable("[maior_prec_op_arit]");
    public static final Variable MAIOR_PREC_UN_ARIT =
            new Variable("maior_prec_un_arit");
    public static final Variable MAIOR_PREC_UN_ARIT_OPERATORS =
            new Variable("maior_prec_un_arit_op");
    ...
    public static GLC createGLCExpression() {
        ...
        glc.addDerivation(new Derivation(EXPR_LOG, MAIOR_PREC_LOG,
                OPTIONAL_MENOR_PREC_LOG));
        glc.addDerivation(new Derivation(EXPR_LOG, BOOLEAN_CTE));
        glc.addDerivation(new Derivation(MENOR_PREC_LOG, OP_OR, MAIOR_PREC_LOG,
                OPTIONAL_MENOR_PREC_LOG));
        glc.addDerivation(new Derivation(MAIOR_PREC_LOG, MAIOR_PREC_UN_LOG,
                OPTIONAL_MAIOR_PREC_OP_LOG));
        glc.addDerivation(new Derivation(MAIOR_PREC_OP_LOG, OP_AND,
                MAIOR_PREC_UN_LOG, OPTIONAL_MAIOR_PREC_OP_LOG));
        glc.addDerivation(new Derivation(MAIOR_PREC_UN_LOG, OP_NOT,
                MAIOR_PREC_UN_LOG));
...
//        glc.addDerivation(new Derivation(AUX_EXPR_LOG, EXPR_REL));
        ...
        glc.addDerivation(new Derivation(OPERATION, OPERATION_OPERATORS,
                FIRST_ELEM));
        ...
        glc.addDerivation(new Derivation(EXPR_ARIT, MAIOR_PREC_ARIT,
                OPTIONAL_MENOR_PREC_ARIT));
        glc.addDerivation(new Derivation(MENOR_PREC_ARIT,
                MENOR_PREC_ARIT_OPERATORS, MAIOR_PREC_ARIT,
                OPTIONAL_MENOR_PREC_ARIT));

        glc.addDerivation(new Derivation(MAIOR_PREC_ARIT, MAIOR_PREC_UN_ARIT,
                OPTIONAL_MAIOR_PREC_OP_ARIT));
        glc.addDerivation(new Derivation(MAIOR_PREC_OP_ARIT,
                MAIOR_PREC_OP_ARIT_OPERATORS, MAIOR_PREC_UN_ARIT,
                OPTIONAL_MAIOR_PREC_OP_ARIT));
//        glc.addDerivation(new Derivation(MAIOR_PREC_UN_ARIT, MAIOR_PREC_UN_ARIT_OPERATORS, MAIOR_PREC_UN_ARIT));
        glc.addDerivation(new Derivation(MAIOR_PREC_UN_ARIT, OPEN_PARENTHESES,
                EXPR_ARIT, CLOSE_PARENTHESES));
...
//        glc.setInitialElement(E);
    ...
    public static GLC createGLCDeclaration() {
        ...
        glc.addDerivation(new Derivation(DIM, OPEN_SQUARE_BRACKET, DIM_TYPE,
...
//        glc.addDerivation(new Derivation(DIM_TYPE, INT_CTE));
        ...
        glc.addDerivation(new Derivation(VAR, ID, VAR_IDS, COLON, TIPO,
                OPTIONAL_DIM));
...
//        glc.addDerivation(new Derivation(OPT_INDEX, ));
        ...
        //index
        glc.addDerivation(new Derivation(INDEX, OPEN_SQUARE_BRACKET, INDEX_VAL,
                CLOSE_SQUARE_BRACKET));
...
//        glc.addDerivation(new Derivation(INDEX_VAL, ID));
        glc.addDerivation(new Derivation(INDEX_VAL, EXPR));
        return glc;
    }
