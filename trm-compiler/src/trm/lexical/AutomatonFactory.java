...
public class AutomatonFactory {
    ...
    public static Automaton createAutomaton() {
        ...
        State realState = new State("4", new StateDescription(WordType.REAL_CTE));
        State integerState = new State("5", new StateDescription(WordType.INTEGER_CTE));
        State firstCharState = new State("6", new StateDescription());
        State secondCharState = new State("7", new StateDescription());
        State charState = new State("8", new StateDescription(WordType.CHARACTER_CTE));
        State firstStringState = new State("9", new StateDescription());
        State stringState = new State("10", new StateDescription(WordType.STRING_CTE));
        State openCurlyBracketState = new State("11", new StateDescription(WordType.OPEN_CURLY_BRACKET));
        State closeCurlyBracketState = new State("12", new StateDescription(WordType.CLOSE_CURLY_BRACKET));
        State openParenthesesState = new State("13", new StateDescription(WordType.OPEN_PARENTHESES));
        State closeParenthesesState = new State("14", new StateDescription(WordType.CLOSE_PARENTHESES));
        ...
        State equalState = new State("17", new StateDescription(WordType.EQUAL));
        State greaterThanState = new State("18", new StateDescription(WordType.GREATER_THAN));
        State greaterOrEqualState = new State("19", new StateDescription(WordType.GREATER_OR_EQUAL));
        State lessThanState = new State("20", new StateDescription(WordType.LESS_THAN));
        State lessOrEqualState = new State("21", new StateDescription(WordType.LESS_OR_EQUAL));
        State openSquareBracketState = new State("22", new StateDescription(WordType.OPEN_SQUARE_BRACKET));
        State closeSquareBracketState = new State("23", new StateDescription(WordType.CLOSE_SQUARE_BRACKET));
        State semiColonState = new State("24", new StateDescription(WordType.SEMICOLON));
        State colonState = new State("25", new StateDescription(WordType.COLON));
        State firstNotEqualState = new State("26", new StateDescription());
        State notEqualState = new State("27", new StateDescription(WordType.NOT_EQUAL));
        State atributionState = new State("28", new StateDescription(WordType.ATRIBUTION));
        State commanState = new State("29", new StateDescription(WordType.COMMAN));
        State maybeDivState = new State("30", new StateDescription(WordType.DIV));
        State barAsteriskCommentState = new State("31", new StateDescription());
        State barAsteriskCommentTwoState = new State("32", new StateDescription());
        State barBarCommentState = new State("33", new StateDescription());
        State multState = new State("34", new StateDescription(WordType.MULT));
        ...
        Automaton automaton = new Automaton(startState, idState, integerState, realState, charState, stringState,
                ...
                subState, equalState, greaterThanState, lessThanState, openSquareBracketState,
